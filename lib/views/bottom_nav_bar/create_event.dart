...
class _CreateEventViewState extends State<CreateEventView> {
  ...
  List<String> list_item = ['College Event', 'Private','Public','Party','Sports','Wedding','Anniversary','General','DJ','Other'];



  String accessModifier = 'Open';
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border(
                              bottom: BorderSide(color: Colors.black.withOpacity(0.9),width: 0.6)
                          )
                      ),
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              foregroundColor: AppColors.black, backgroundColor: Colors.white, // Text color
                            ...
                            child: Text(
                              'Upload',
                              style: TextStyle(
                                color: AppColors.black, // Ensure the text color is set here
                              ),
                            ),
                          ),
                        ],
